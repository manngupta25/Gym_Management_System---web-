...
<nav class="navbar navbar-expand-lg " style="background-color: #e3f2fd;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-1 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="facilities.php">Facility</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <h1>
            <center>&mdash; Our Facilities &mdash;</center>
        </h1>
        <br>
        <table>
            <tr>
                <td> &nbsp;<img src="image/cardio.png"></td>
                <td valign=top>&nbsp;&nbsp;&nbsp;<h4>Cardio Center</h4>
                    <hr>
                    Cardio is short for cardiovascular, which refers to the heart. Cardiovascular exercise is exercise
                    that raises your heart rate and keeps it elevated for a period of time. The kinds of exercise that
                    are associated with cardiovascular workouts are things like jogging, fast walking, and swimming
                    where there is no break in the routine. Exercises that
        ...
        <table>
            <tr>
                <td>
                    <h4>Cycling Area</h4>
                    <hr>Indoor cycling is a great way to get in your
                    cardio each week. It is a low-impact workout, but it is no ride in the park. Many classes are very
                    high intensity, so talk to your instructor and doctor first if you are out of shape, are pregnant,
                    or have any medical problems. They can help tailor the program to your needs.Cycling helps your
                    muscles use glucose more efficiently, so your blood sugar level is likely to go down. If you have
                    diabetes, your doctor will need to adjust your medications.
                </td>

                <td><img src="image/download (1).jpg" class="rounded"></td>
            </tr>
        </table>
        <br>
        <br>
        <table>
            <tr>
                <td> &nbsp;<img src="image/strength.png"></td>
                <td valign=top>&nbsp;&nbsp;&nbsp;<h4>Strength Training</h4>
                    <hr>A method of improving muscular strength by
        ...
        <table>
            <tr>
                <td>
                    ...
                    <hr>Weightlifting or weight lifting generally refers to physical exercises and
                    sports in which people lift weights, often in the form of dumbbells or barbells. People engage in
                    weightlifting for a variety of different reasons. These can include: developing physical strength;
                    promoting health and fitness; competing in weightlifting sports; and developing a muscular and
                    aesthetic physique.
                </td>

                <td><img src="image/lifting.jpg" class="rounded"></td>
            </tr>
        </table>
        <br>
        <br>
        <table>
            <tr>
                <td> &nbsp;<img src="image/weight area.jpg" class="rounded"></td>
                <td valign=top>&nbsp;&nbsp;<h4>Free weight area</h4>
                    <hr>The basic workout tools in this area include
                    dumbbells, barbells, benches, power racks and press stations. When you join a Holmes Place club,
                    we will include the amount of sets and reps you need to perform in your personalised plan (if this
                    area is necessary to achieve your goals). Using a ‘spotter’ (someone to support you lift weights
                    safely) can help prevent injuries in this area and motivate you to lift to your maximum potential.
                </td>
            </tr>
        </table>
        <br>
        ...
        <table>
            <tr>
                ...
                <td><img src="image/aerobic a.jpg"></td>
            </tr>
        </table>
        <br>
        ...
        <table style="margin-left:500px;">
            <tr>
                <td>
                    <h4>&mdash; Other Facilities &mdash;</h4>
                    <hr>
                    <ul>
                        <li>Wifi</li>
                        <li>Lockers</li>

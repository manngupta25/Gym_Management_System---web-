    ...
    <div class="container  ">
        ...
        <div class="card text-center border-light">
            <h3 class="card-title"><br>
                <center>&mdash; Our Objectives &mdash;</center>
            </h3>
            <hr>
            <p class="card-body">
                Our main objective is to create awareness and to Co-ordinate the performance of body,
                mind and soul in a befitting manner, we are the winner, we don’t do different thing, we do things
                differently. Our goal is to be sensitive to our members needs and to fulfill fitness requirements. We
                ensure
                physical fitness and robust health to customers as we counsel, we assist, we motivate them to lead a
                joyous
                and meaningful results are bound to be positive as we put in our 200% to fulfill your needs.
            </p>
        </div>
        <br><br>
        <h4 class="italic bg-success p-2 text-dark bg-opacity-50">
            <center>“Life is not merely living but living in health.”</center>
        </h4>
        <br><br>
        <div class="card text-center border-light">
            <h3 class="card-title"><br>
                <center>&mdash; Our vision &mdash;</center>
            </h3>
            <hr>
            <p class="card-body">
                Our vision is to provide an Entertaining, Educational, Friendly, and
                Inviting, Functional and Innovative experience of uncompromising quality that meets the health and
                fitness
